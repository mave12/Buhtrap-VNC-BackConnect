...
#define	BC_DEFAULT_DB_SERVER		_T("127.0.0.1")		// MySQL database host 	
#define	BC_DEFAULT_DB_PORT			3306					// MySQL database port
...
#define	BC_DEFAULT_DB_USER			_T("root")		// database user name
#define	BC_DEFAULT_DB_PASSWORD		_T("root")			// database user password
